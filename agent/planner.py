...
PLANNER_PROMPT = """You are the planning module of VEGA, a personal AI assistant.
...
- Max 8 steps. Use the minimum steps needed. For complex multi-step research or file tasks, use up to 8.
